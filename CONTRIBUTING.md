...
[existing-feature-request]: https://github.com/RIOT-OS/RIOT/issues?q=state:open+type:issue+label:"new+feature"
...
* Before opening a new Pull Request, have a look at
  ...
  Old and stalled [PRs are sometimes archived][archived-pull-requests] with a
...
[archived-pull-requests]: https://github.com/RIOT-OS/RIOT/pulls?q=is:pr+label:memo
