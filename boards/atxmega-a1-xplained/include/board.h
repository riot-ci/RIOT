 ...
 * @{
 */
#define LED0_PIN            GPIO_PIN(PORT_E, PIN0_bm)
...
#define LED1_PIN            GPIO_PIN(PORT_E, PIN1_bm)
...
#define LED2_PIN            GPIO_PIN(PORT_E, PIN2_bm)
...
#define LED3_PIN            GPIO_PIN(PORT_E, PIN3_bm)
...
#define LED4_PIN            GPIO_PIN(PORT_E, PIN4_bm)
...
#define LED5_PIN            GPIO_PIN(PORT_E, PIN5_bm)
...
#define LED6_PIN            GPIO_PIN(PORT_E, PIN6_bm)
...
#define LED7_PIN            GPIO_PIN(PORT_E, PIN7_bm)
