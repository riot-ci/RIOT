...
static const clock_config_t clock_config = {
    ...
    .pll_vdiv  = MCG_C6_VDIV0(0b00100), /* Multiply by 20 => PLL freq = 240 MHz => 120 * 2 */
};
...
static const adc_conf_t adc_config[] = {
    ...
    [ 2] = { .dev = ADC0, .pin = GPIO_PIN(PORT_A,  7), .chan = 10, .avg = ADC_AVG_MAX }, /* PTA7 (Arduino A0) */
    [ 3] = { .dev = ADC0, .pin = GPIO_PIN(PORT_A,  8), .chan = 11, .avg = ADC_AVG_MAX }, /* PTA8 (Arduino A1) */
    [ 4] = { .dev = ADC0, .pin = GPIO_PIN(PORT_D,  1), .chan =  5, .avg = ADC_AVG_MAX }, /* PTD1 (Arduino A2) */
    [ 5] = { .dev = ADC0, .pin = GPIO_PIN(PORT_D,  6), .chan =  7, .avg = ADC_AVG_MAX }, /* PTD6 (Arduino A3) */
    [ 6] = { .dev = ADC0, .pin = GPIO_PIN(PORT_B,  2), .chan = 12, .avg = ADC_AVG_MAX }, /* PTB2 (Arduino A4) */
    [ 7] = { .dev = ADC0, .pin = GPIO_PIN(PORT_B,  3), .chan = 13, .avg = ADC_AVG_MAX }, /* PTB3 (Arduino A5) */
