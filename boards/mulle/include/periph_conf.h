...
static const adc_conf_t adc_config[] = {
    ...
    { .dev = ADC1, .pin = GPIO_UNDEF,           .chan = 26 },
    /* internal: band gap */
    { .dev = ADC1, .pin = GPIO_UNDEF,           .chan = 27 },
    /* internal: V_REFSH */
    { .dev = ADC1, .pin = GPIO_UNDEF,           .chan = 29 },
    /* internal: V_REFSL */
    { .dev = ADC1, .pin = GPIO_UNDEF,           .chan = 30 },
    /* internal: DAC0 module output level */
    { .dev = ADC1, .pin = GPIO_UNDEF,           .chan = 23 },
    /* internal: VREF module output level */
    { .dev = ADC1, .pin = GPIO_UNDEF,           .chan = 18 },
     /* on board connection to Mulle Vbat/2 on PGA1_DP pin */
    { .dev = ADC1, .pin = GPIO_UNDEF,           .chan =  0 },
    /* on board connection to Mulle Vchr/2 on PGA1_DM pin */
    { .dev = ADC1, .pin = GPIO_UNDEF,           .chan = 19 },
    /* expansion port PGA0_DP pin */
    { .dev = ADC0, .pin = GPIO_UNDEF,           .chan =  0 },
    /* expansion port PGA0_DM pin */
    { .dev = ADC0, .pin = GPIO_UNDEF,           .chan = 19 },
    /* expansion port PTA17 */
    { .dev = ADC1, .pin = GPIO_PIN(PORT_A, 17), .chan = 17 },
    /* expansion port PTB0  */
    { .dev = ADC1, .pin = GPIO_PIN(PORT_B,  0), .chan =  8 },
    /* expansion port PTC0  */
    { .dev = ADC0, .pin = GPIO_PIN(PORT_C,  0), .chan = 14 },
    /* expansion port PTC8  */
    { .dev = ADC1, .pin = GPIO_PIN(PORT_C,  8), .chan =  4 },
    /* expansion port PTC9  */
    { .dev = ADC1, .pin = GPIO_PIN(PORT_C,  9), .chan =  5 },
    /* expansion port PTC10 */
    { .dev = ADC1, .pin = GPIO_PIN(PORT_C, 10), .chan =  6 },
    /* expansion port PTC11 */
    { .dev = ADC1, .pin = GPIO_PIN(PORT_C, 11), .chan =  7 }
};
