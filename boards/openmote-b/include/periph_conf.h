...
#define I2C_0_SCL_PIN           GPIO_PB5 /* SI7006 Temp/RH sensor */
#define I2C_0_SDA_PIN           GPIO_PB4 /* SI7006 Temp/RH sensor */

static const i2c_conf_t i2c_config[I2C_NUMOF] = {
    {
        .scl_pin = GPIO_PB5, /* SI7006 Temp/RH sensor */
        .sda_pin = GPIO_PB4, /* SI7006 Temp/RH sensor */
    },
};
/** @} */
