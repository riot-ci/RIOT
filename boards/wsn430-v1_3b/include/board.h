 ...
 * @{
 */
#define CC110X_PARAMS_CS            (GPIO_PIN(P4, 2))
#define CC110X_PARAMS_GDO0          (GPIO_PIN(P1, 3))
#define CC110X_PARAMS_GDO1          (GPIO_PIN(P5, 2))
#define CC110X_PARAMS_GDO2          (GPIO_PIN(P1, 4))
/** @} */
