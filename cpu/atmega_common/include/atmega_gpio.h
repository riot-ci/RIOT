 ...
 */
static inline gpio_reg_t atmega_port_addr(const gpio_port_t *port)
{
    return port->reg;
}
 ...
 */
static inline gpio_reg_t atmega_ddr_addr(const gpio_port_t *port)
{
 ...
 */
static inline gpio_reg_t atmega_pin_addr(const gpio_port_t *port)
{
    return (atmega_port_addr(port) - 0x02);
}

/**
 * @brief     Generat the port number of the given port
 */
static inline uint8_t atmega_port_num(const gpio_port_t *port)
{
