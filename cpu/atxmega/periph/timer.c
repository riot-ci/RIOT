...
typedef struct {
    ...
    int_lvl_t int_lvl;      /**< interrupt level */
} ctx_t;
...
static ctx_t ctx[] = {
#ifdef TIMER_0
    { TIMER_0, NULL, NULL, 0, 0, TIMER_0_INT_LVL },
#endif
#ifdef TIMER_1
    { TIMER_1, NULL, NULL, 0, 0, TIMER_1_INT_LVL },
#endif
#ifdef TIMER_2
    { TIMER_2, NULL, NULL, 0, 0, TIMER_2_INT_LVL },
#endif
#ifdef TIMER_3
    { TIMER_3, NULL, NULL, 0, 0, TIMER_3_INT_LVL },
#endif
};
#else
...
int timer_set_absolute(tim_t tim, int channel, unsigned int value)
{
    ...
    *(((uint16_t *)(&ctx[tim].dev->CCA)) + channel) = (uint16_t)value;
    ...
    ctx[tim].dev->INTCTRLB |= (ctx[tim].int_lvl << channel);
