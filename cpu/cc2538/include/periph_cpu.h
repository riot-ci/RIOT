 ...
 * @param[in] pin   gpio pin
 * @param[in] over  Override pin configuration
 * @param[in] sel   Select peripheral function for pin
 * @param[in] func  Set pin for peripheral function
 */
 void gpio_init_mux(gpio_t pin, cc2538_ioc_over_t over,
                    cc2538_ioc_sel_t sel, cc2538_ioc_pin_t func);
