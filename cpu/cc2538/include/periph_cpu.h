 ...
 *
 * @param[in] pin   gpio pin
 * @param[in] sel   Setting for IOC select register
 * @param[in] over  Setting for IOC override register
 *
 * @return          Internal port-pin number of given GPIO
 */
uint8_t gpio_init_af(gpio_t pin, unsigned sel, unsigned over);
