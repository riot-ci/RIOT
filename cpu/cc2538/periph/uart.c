...
static int init_base(uart_t uart, uint32_t baudrate)
{
    ...
    switch (uart) {
        ...
        case UART_0:
             ...
             */
            IOC_UARTRXD_UART0 = cc2538_gpio_pp_num(UART_0_RX_PIN);
             ...
             * - Output Enable
             */
            IOC_PXX_SEL[cc2538_gpio_pp_num(UART_0_TX_PIN)] = UART0_TXD;
            IOC_PXX_OVER[cc2538_gpio_pp_num(UART_0_TX_PIN)] = IOC_OVERRIDE_OE;

            /* Set RX and TX pins to peripheral mode */
            cc2538_gpio_hw_ctrl(UART_0_TX_PIN);
            cc2538_gpio_hw_ctrl(UART_0_RX_PIN);
            break;
#endif
#if UART_1_EN
        case UART_1:
             ...
             * Select the UARTx RX pin by writing to the IOC_UARTRXD_UARTn register
             */
            IOC_UARTRXD_UART1 = cc2538_gpio_pp_num(UART_1_RX_PIN);
             ...
             * - Output Enable
             */
            IOC_PXX_SEL[cc2538_gpio_pp_num(UART_1_TX_PIN)] = UART1_TXD;
            IOC_PXX_OVER[cc2538_gpio_pp_num(UART_1_TX_PIN)] = IOC_OVERRIDE_OE;

            /* Set RX and TX pins to peripheral mode */
            cc2538_gpio_hw_ctrl(UART_1_TX_PIN);
            cc2538_gpio_hw_ctrl(UART_1_RX_PIN);
            break;
#endif
    ...
    if (u == UART1) {
        ...
        IOC_PXX_SEL[cc2538_gpio_pp_num(UART_1_RTS_PIN)] = UART1_RTS;
        cc2538_gpio_hw_ctrl(UART_1_RTS_PIN);
        IOC_PXX_OVER[cc2538_gpio_pp_num(UART_1_RTS_PIN)] = IOC_OVERRIDE_OE;
        u->cc2538_uart_ctl.CTLbits.RTSEN = 1;
#endif

#ifdef UART_1_CTS_PIN
        IOC_UARTCTS_UART1 = cc2538_gpio_pp_num(UART_1_CTS_PIN);
        cc2538_gpio_hw_ctrl(UART_1_CTS_PIN);
        IOC_PXX_OVER[cc2538_gpio_pp_num(UART_1_CTS_PIN)] = IOC_OVERRIDE_DIS;
