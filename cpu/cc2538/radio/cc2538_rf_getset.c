...
int cc2538_get_eui64_primary(const void *arg, eui64_t *addr)
{
    (void) arg;
     ...
     */
    addr->uint8[0] = ((uint8_t*)CC2538_EUI64_LOCATION_PRI)[4];
    addr->uint8[1] = ((uint8_t*)CC2538_EUI64_LOCATION_PRI)[5];
    addr->uint8[2] = ((uint8_t*)CC2538_EUI64_LOCATION_PRI)[6];
    addr->uint8[3] = ((uint8_t*)CC2538_EUI64_LOCATION_PRI)[7];
    addr->uint8[4] = ((uint8_t*)CC2538_EUI64_LOCATION_PRI)[0];
    addr->uint8[5] = ((uint8_t*)CC2538_EUI64_LOCATION_PRI)[1];
    addr->uint8[6] = ((uint8_t*)CC2538_EUI64_LOCATION_PRI)[2];
    addr->uint8[7] = ((uint8_t*)CC2538_EUI64_LOCATION_PRI)[3];
