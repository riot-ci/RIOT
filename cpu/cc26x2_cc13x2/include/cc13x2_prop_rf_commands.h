 ...
 *
 * @note    @p next_cmd will only be ran if this command succeeds
 *          (COND_STOP_ON_FALSE).
 *
 ...
 *
 * @note    If @p next_cmd is present (not 0) the next command will be ran
...
/**
 * @brief   Construct a CMD_ABORT command.
 *
...
/**
 * @brief   Construct a CMD_PING command.
 *
 * @note    This is a direct command, it doesn't have an _address_.
 *
 * @return uint32_t The command value.
 ...
 *
 * @return uint8_t The result byte of the RFC_DBELL.CMDSTA register.
 */
