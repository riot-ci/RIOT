 ...
 *
 * @note    Must be called before @ref cc13x2_prop_rf_power_on on device
 *          initialization.
 */
 ...
 * @param[in] force   Force the channel change even if we are on that channel.
 */
 ...
 */
int cc13x2_prop_rf_recv(void *buf,
                        size_t len,
