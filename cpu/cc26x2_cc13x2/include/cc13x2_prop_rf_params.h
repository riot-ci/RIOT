...
#define CC13X2_MAX_PACKET_SIZE      (2047) /**< Maximum packet size */

#ifndef CC13X2_CHANNEL_MIN_SUB_GHZ
/**
 * @brief   Minimum channel for Sub-GHz band
 */
#define CC13X2_CHANNEL_MIN_SUB_GHZ  (0U)
#endif

#ifndef CC13X2_CHANNEL_MAX_SUB_GHZ
/**
 * @brief   Maximum channel for Sub-GHz band
 */
#define CC13X2_CHANNEL_MAX_SUB_GHZ  (129U)
#endif
...
/**
 * @brief   Center frequency for the Sub-GHz band in MHz
 */
#define CC13X2_CENTER_FREQ_SUB_GHZ  (915U)
#endif

#ifndef CC13X2_LO_DIVIDER_SUB_GHZ
/**
 * @brief   LO divider for the Sub-GHz band
 */
#define CC13X2_LO_DIVIDER_SUB_GHZ   (0x05U)
#endif
 ...
 */
/**
 * @brief   SFD value for uncoded (PHR + PSDU)
 */
#define IEEE802154_2FSK_UNCODED_SFD_0 (0x0000904EU)

/**
 * @brief   SFD value for uncoded (PHR + PSDU)
 */
#define IEEE802154_2FSK_UNCODED_SFD_1 (0x00007A0EU)

/**
 * @brief   Size in bits of the SFD
 */
#define IEEE802154_2FSK_SFD_SIZE      (16U)
/** @} */
 ...
 * @brief   Size in bits of the PHR
 */
#define IEEE802154_PHR_BITS (IEEE802154_PHR_SIZE * 8)

/**
 * @brief   Size in bits of the Frame Length field
 */
...
/**
 * @brief   Unknown value for the EUI64 address on the CCFG
 */
#define CCFG_UNKNOWN_EUI64 (0xFFU)

/**
 * @brief   Calculate the channel frequency for a given channel number.
 *
 * @pre (@p chan >= CC13X2_CHANNEL_MIN_SUB_GHZ) &&
 *      (@p chan <= CC13X2_CHANNEL_MAX_SUB_GHZ)
 *
 ...
 */
static inline void cc13x2_prop_rf_freq_parts(const uint32_t freq,
                                             uint16_t *dec,
                                             uint16_t *frac)
{
    assert(dec != NULL);
