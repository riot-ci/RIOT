...
static volatile CMD_ALIGN rfc_CMD_PROP_RADIO_DIV_SETUP_t
    _cmd_prop_radio_div_setup;
...
{
    memset_volatile(&_cmd_prop_radio_div_setup,
                    0, sizeof(_cmd_prop_radio_div_setup));
    ...
    _cmd_prop_radio_div_setup.modulation.deviation
        = CC13X2_MODULATION_DEVIATION;
    _cmd_prop_radio_div_setup.modulation.deviationStepSz
        = CC13X2_MODULATION_DEVIATION_STEP_SIZE;
