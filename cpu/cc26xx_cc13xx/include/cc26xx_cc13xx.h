...
typedef enum IRQn
{
    ...
    MemoryManagement_IRQn = -12, /**<  4 Cortex-M4 Memory Management Interrup */
    ...
    AON_AUX_SWEV0_IRQN    =   6, /**< 22 Sensor Controller software event 0,
                                      through AON domain */
    ...
    I2S_IRQN              =  12, /**< 28 I2S                                  */
    AON_AUX_SWEV1_IRQN    =  13, /**< 29 Sensor Controller software event 1,
                                      through AON domain */
    ...
    AUX_COMBO_IRQN        =  28, /**< 44 AUX combined event, directly to MCU
                                         domain */
    AON_PRG0_IRQN         =  29, /**< 45 AON programmable 0                   */
    PROG_IRQN             =  30, /**< 46 Dynamic Programmable interrupt (default
                                         source: PRCM) */
    AUX_COMPA_IRQN        =  31, /**< 47 AUX Comparator A                     */
    AUX_ADC_IRQN          =  32, /**< 48 AUX ADC IRQ                          */
    TRNG_IRQN             =  33, /**< 49 TRNG event                           */
#ifdef CPU_VARIANT_X2
    OSC_IRQN              =  34, /**< 50 Combined event from oscillator
                                         control */
...
/** CC13xx/CC26xx do provide an MPU */
#define __MPU_PRESENT          1
/** CC13xx/CC26xx offers priority levels from 0..7 */
