...
enum {
    ...
    RFC_CMDSTA_ILLEGALPOINTER = 0x81, /**< The pointer signaled in CMDR is not
                                           valid */
    ...
    RFC_CMDSTA_CONTEXTERROR = 0x85, /**< An immediate or direct command was
                                         issued in a context where it is not
                                         supported */
    ...
    RFC_CMDSTA_PARERROR = 0x87, /**< There were errors in the command parameters
                                     that are parsed on submission. */
    RFC_CMDSTA_QUEUEERROR = 0x88, /**< An operation on a data entry queue was
                                       attempted that was not supported by the
                                       queue in its current state */
    RFC_CMDSTA_QUEUEBUSY = 0x89, /**< An operation on a data entry was attempted
                                      while that entry was busy */
};
...
enum {
    ...
    RFC_COND_STOP_ON_TRUE = 3, /**< Stop if this command returned True, run next
...
enum {
    ...
    RFC_ERROR_CMDID = 0x0805, /**< Next operation has a command ID that is
                                   undefined or not a radio operation command */
    ...
    RFC_ERROR_NO_RX = 0x080C, /**< Attempted to access data from Rx when no such
                                   data was yet received */
