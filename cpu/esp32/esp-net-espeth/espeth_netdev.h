...
/**
 * @defgroup        cpu_esp32_esp_net_espeth ESP32 Ethernet interface
 * @ingroup         cpu_esp32
...
#ifndef ESPETH_NETDEV_H
#define ESPETH_NETDEV_H
 ...
 */
extern const netdev_driver_t espeth_driver;
...
typedef struct
{
    ...
    uint8_t rx_mac[ETHERNET_ADDR_LEN];  /**< source address */
