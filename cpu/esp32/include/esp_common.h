...
#define ESP_EARLY_LOGE(tag, fmt, ...) ets_printf("E (%u) %s: " fmt "\n", \
                                                 system_get_time_ms(), tag, ##__VA_ARGS__)
#define ESP_EARLY_LOGW(tag, fmt, ...) ets_printf("W (%u) %s: " fmt "\n", \
                                                 system_get_time_ms(), tag, ##__VA_ARGS__)
#define ESP_EARLY_LOGI(tag, fmt, ...) ets_printf("I (%u) %s: " fmt "\n", \
                                                 system_get_time_ms(), tag, ##__VA_ARGS__)
#define ESP_LOGE(tag, fmt, ...) ets_printf("E (%u) %s: " fmt "\n", \
                                           system_get_time_ms(), tag, ##__VA_ARGS__)
#define ESP_LOGW(tag, fmt, ...) ets_printf("W (%u) %s: " fmt "\n", \
                                           system_get_time_ms(), tag, ##__VA_ARGS__)
#define ESP_LOGI(tag, fmt, ...) ets_printf("I (%u) %s: " fmt "\n", \
                                           system_get_time_ms(), tag, ##__VA_ARGS__)
...
#define ESP_EARLY_LOGD(tag, fmt, ...) ets_printf("D (%u) %s: " fmt "\n", \
                                                 system_get_time_ms(), tag, ##__VA_ARGS__)
#define ESP_EARLY_LOGV(tag, fmt, ...) ets_printf("V (%u) %s: " fmt "\n", \
                                                 system_get_time_ms(), tag, ##__VA_ARGS__)
#define ESP_LOGD(tag, fmt, ...) ets_printf("D (%u) %s: " fmt "\n", \
                                           system_get_time_ms(), tag, ##__VA_ARGS__)
#define ESP_LOGV(tag, fmt, ...) ets_printf("V (%u) %s: " fmt "\n", \
                                           system_get_time_ms(), tag, ##__VA_ARGS__)
