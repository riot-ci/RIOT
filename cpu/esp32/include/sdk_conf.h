 ...
 *
 * The SDK configuration can be partially overriden by the application.
 * For that purpose, create a file ```sdk_conf_app.h``` in the application
 * source directory. Please refer file
 *
 *      ```$(RIOTCPU)/$(CPU)/include/default/sdk_conf_app.h```
 *
 * for more information, what parts can be overridden and what values
 * are possible.
 *
...
/**
 * @brief   Include application specific SDK configuration
 */
#include "sdk_conf_app.h"

/**
 * Default console configuration
 *
 * CONFIG_CONSOLE_UART_BAUDRATE is also used as UART_STDIO_BAUDRATE and
 * can be overriden by an application specific SDK configuration file.
 */
 ...
 *
 * CONFIG_LOG_DEFAULT_LEVEL can be overriden by an application specific
...
#define CONFIG_SPI_FLASH_DRIVE_START            0
