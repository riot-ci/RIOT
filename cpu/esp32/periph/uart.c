...
static struct uart_hw_t __uarts[] = {
    ...
    #if !defined(UART1_NOT_AVAILABLE)
    {   .regs = &UART1,
        .pin_txd = UART1_TXD,
        .pin_rxd = UART1_RXD,
    ...
    #endif
    #if !defined(UART2_NOT_AVAILABLE)
    {   .regs = &UART2,
        .pin_txd = UART2_TXD,
        .pin_rxd = UART2_RXD,
...
int uart_init(uart_t uart, uint32_t baudrate, uart_rx_cb_t rx_cb, void *arg)
{
    ...
    if (uart == UART_DEV(1) || uart == UART_DEV(2)) {
        ...
        _gpio_pin_usage[__uarts[uart].pin_txd] = _UART;
        _gpio_pin_usage[__uarts[uart].pin_rxd] = _UART;
