...
#define LIGHT_SLEEP_TIME_OVERHEAD_US (650 + 30 * 240 / CLOCK_CORECLOCK)
#define DEEP_SLEEP_TIME_OVERHEAD_US (650 + 100 * 240 / CLOCK_CORECLOCK)
#else
#define LIGHT_SLEEP_TIME_OVERHEAD_US (250 + 30 * 240 / CLOCK_CORECLOCK)
#define DEEP_SLEEP_TIME_OVERHEAD_US (250 + 100 * 240 / CLOCK_CORECLOCK)
