...
typedef struct {
    unsigned long ssi_sysctl;          /**< SSI device */
    unsigned long ssi_base;            /**< SSI base address */
    unsigned long gpio_sysctl;         /**< GPIO device */
    unsigned long gpio_port;           /**< GPIO port */
    struct {
        unsigned long clk;             /**< Clock pin */
        unsigned long fss;             /**< FSS pin */
        unsigned long rx;              /**< RX pin */
        unsigned long tx;              /**< TX pin */
