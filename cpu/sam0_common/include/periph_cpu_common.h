 ...
 * triggered. On the SAML platform, these descriptors must reside in the LP
 * SRAM.
 */
...
/**
 * @brief Move the DMA descriptors to the LP SRAM. Required on the SAML21 and
 * SAML1X families
 */
#if defined(CPU_FAM_SAML21) || defined(CPU_FAM_SAML1X)
 ...
 * untouched
 *
 * @note This only touches the source address, lenght and source increment
 ...
 * untouched
 *
 * @note This only touches the destination address, lenght and destination
 ...
 * @param   incr        Whether to increment the source address after a beat
 */
void dma_append_src(dma_t dma, DmacDescriptor *extra, void *src, size_t len,
                    bool incr);
 ...
 * @param   incr        Whether to increment the source address after a beat
 */
void dma_append_dst(dma_t dma, DmacDescriptor *extra, void *dst, size_t len,
                    bool incr);
