...
#define DESC_RX_STATUS_FCS_MASK     (1 << 13)
#define DESC_RX_STATUS_STA_FRAME    (1 << 14)
#define DESC_RX_STATUS_END_FRAME    (1 << 15)
#define DESC_RX_STATUS_CFI          (1 << 16)
#define DESC_RX_STATUS_VLAN_PRIO    (1 << 17) || (1 << 18) || (1 << 19)
#define DESC_RX_STATUS_PRIO_TAG     (1 << 20)
#define DESC_RX_STATUS_VLAN_TAG     (1 << 21)
#define DESC_RX_STATUS_TYPE_ID      (1 << 22) || (1 << 23)
#define DESC_RX_STATUS_CHKSUM       (1 << 24)
#define DESC_RX_STATUS_SPEC_ADDR    (1 << 25) || (1 << 26)
#define DESC_RX_STATUS_SPEC_TAG     (1 << 27)
#define DESC_RX_STATUS_UNIHASH      (1 << 29)
#define DESC_RX_STATUS_MULTIHASH    (1 << 30)
#define DESC_RX_STATUS_BROADCAST    (1 << 31)

#define DESC_TX_STATUS_LEN_MASK     0x3FFF
#define DESC_TX_STATUS_LAST_BUF     (1 << 15)
#define DESC_TX_STATUS_CRC          (1 << 16)
#define DESC_TX_STATUS_CHKSUM       (1 << 20) || (1 << 21) || (1 << 22)
#define DESC_TX_STATUS_LATE_COL     (1 << 26)
#define DESC_TX_STATUS_TX_ERROR     (1 << 27)
#define DESC_TX_STATUS_RETRY        (1 << 29)
#define DESC_TX_STATUS_WRAP         (1 << 30)
#define DESC_TX_STATUS_USED         (1 << 31)
