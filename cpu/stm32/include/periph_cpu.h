...
/**
 *@brief     The port number of the first GPIO expander port
 *
 * GPIO_EXP_PORT defines the number of the first GPIO expander port. The
 * port number is a sequential number that goes from 0 to `GPIO_EXP_PORT-1`
 * for MCU ports. For GPIO expanders, the port number is derived from
 * `GPIO_EXP_PORT` and their index in the GPIO device table #gpio_devs as
 * offset.
 */
#if defined(GPIOK)
#define GPIO_EXP_PORT   11
#elif defined(GPIOJ)
#define GPIO_EXP_PORT   10
#elif defined(GPIOI)
#define GPIO_EXP_PORT   9
#elif defined(GPIOH)
#define GPIO_EXP_PORT   8
#elif defined(GPIOG)
#define GPIO_EXP_PORT   7
#elif defined(GPIOF)
#define GPIO_EXP_PORT   6
#elif defined(GPIOE)
#define GPIO_EXP_PORT   5
#elif defined(GPIOD)
#define GPIO_EXP_PORT   4
#elif defined(GPIOC)
#define GPIO_EXP_PORT   3
#elif defined(GPIOB)
#define GPIO_EXP_PORT   2
#else
#define GPIO_EXP_PORT   1
#endif
