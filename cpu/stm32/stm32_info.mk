...
ifeq (f0,$(CPU_FAM_SHORT))
  CPU_ARCH = cortex-m0
else ifneq (,$(filter $(CPU_FAM_SHORT),f1 f2 l1))
  CPU_ARCH = cortex-m3
else ifneq (,$(filter $(CPU_FAM_SHORT),f3 f4 l4))
  CPU_ARCH = cortex-m4f
else ifeq (wb,$(CPU_FAM_SHORT))
  CPU_ARCH = cortex-m4
else ifeq (f7,$(CPU_FAM_SHORT))
  CPU_ARCH = cortex-m7
else ifeq (l0,$(CPU_FAM_SHORT))
