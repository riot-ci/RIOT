...
#if defined(CPU_LINE_STM32F303xC) || defined(CPU_LINE_STM32F358xx) || \
    defined(CPU_LINE_STM32F373xC) || defined(CPU_LINE_STM32F378xx)
/* There is prescaler on these F3 lines */
...
#if CONFIG_CLOCK_MCO_PRE != 1
#error "MCO prescaler is not available on STM32F1 family"
#endif
#define CLOCK_MCO_PRE                           (0)
#endif
