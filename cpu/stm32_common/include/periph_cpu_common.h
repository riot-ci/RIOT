...
typedef enum {
    ...
    UART_DATABITS_5 = UART_INVALID_MODE,  /**< not supported */
#if defined(USART_CR1_M1)
    UART_DATABITS_6 = 3,                  /**< 6 databits */
#else
    UART_DATABITS_6 = UART_INVALID_MODE,  /**< not supported */
#endif
    UART_DATABITS_7 = 1,                  /**< 7 databits */
    UART_DATABITS_9 = UART_INVALID_MODE   /**< not supported */
} uart_databits_t;
/** @} */
...
typedef enum {
   ...
   UART_STOPBITS_2 = USART_CR2_STOP_1,   /**< 2 stopbits */
} uart_stopbits_t;
/** @} */
