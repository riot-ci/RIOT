...
/**
 * @brief Total available FIFO space for the FS devices
 *
 * Some device families forgot to define the FS device FIFO size
 */
...
/**
 * @brief Total available FIFO space for the HS devices
 *
 * Some device families forgot to define the HS device FIFO size
 */
