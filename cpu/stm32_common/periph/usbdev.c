 ...
 */
static void _flush_fifo(stm32_fshs_usb_t *usbdev, uint8_t fifo_num)
{
    const stm32_fshs_usb_config_t *conf = usbdev->config;
...
static void _flush_rx_fifo(stm32_fshs_usb_t *usbdev)
{
    const stm32_fshs_usb_config_t *conf = usbdev->config;
...
static void _isr_ep(stm32_fshs_usb_t *usbdev)
{
    const stm32_fshs_usb_config_t *conf = usbdev->config;
