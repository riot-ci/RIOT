...
# for the stm32 family. Most of the CPUs should be taken into account
# here, so no need to add the variables per CPU or variant.
...
ifeq ($(STM32_TYPE), F)
  ifeq ($(STM32_FAMILY), 0)
    ...
    else ifneq (, $(filter $(STM32_MODEL2), 4))
      RAM_LEN = 6K
