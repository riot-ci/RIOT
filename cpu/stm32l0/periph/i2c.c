...
static void _start(I2C_TypeDef *i2c, uint8_t address, uint8_t nbyte, uint8_t rw_flag);
...
int i2c_init_master(i2c_t dev, i2c_speed_t speed)
{
    ...
    /* set IRQn priority */
//AFU    NVIC_SetPriority(i2c_config[dev].er_irqn, I2C_IRQ_PRIO);

    /* enable IRQn */
//AFU    NVIC_EnableIRQ(i2c_config[dev].er_irqn);
...
//    i2c->CR1 |= I2C_CR1_PE;
    ...
    i2c->TIMINGR = I2C_TIMING & TIMING_CLEAR_MASK;
...
//            i2c->CR2 &= ~(I2C_CR2_NACK);
            ...
            do {
                ...
                *my_data++ = i2c->RXDR;
            } while (!(i2c->CR2 && I2C_CR2_NBYTES_Msk));
...
//    while (!(i2c->SR1 & I2C_SR1_SB)) {}
    ...
    DEBUG("Send address\n");
    i2c->CR2 = (uint32_t)(address << I2C_CR2_SADD_Pos);
	i2c->CR2 |= (uint32_t)(rw_flag << I2C_CR2_RD_WRN_Pos);
	i2c->CR2 |= (uint32_t)(nbyte << I2C_CR2_NBYTES_Pos);
...
//    while (!(i2c->SR1 & I2C_SR1_ADDR)) {} // AFU ?
}
