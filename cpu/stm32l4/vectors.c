...
ISR_VECTOR(1) const isr_t vector_cpu[CPU_IRQ_NUMOF] = {
    ...
    [67] = isr_usb,                  /* [67] USB event Interrupt */
    [82] = isr_crs,                  /* [82] CRS global interrupt */
#elif defined(CPU_MODEL_STM32L476RG)
    [18] = isr_adc1_2,               /* [18] ADC1, ADC2 SAR global Interrupts */
    [26] = isr_tim1_trg_com_tim17,   /* [26] TIM1 Trigger and Commutation Interrupt and TIM17 global interrupt */
