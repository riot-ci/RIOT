...
void at86rf2xx_setup(at86rf2xx_t *dev, const at86rf2xx_params_t *params)
{
     ...
     * as luid_get() only mutates the first byte, no collisions with other
     * locally generated LUIDs will arise, if we simply set the two last bits
     * to its desired value.
     */
    dev->netdev.long_addr[IEEE802154_LONG_ADDRESS_LEN - 1] &= ~(0x01);
    dev->netdev.long_addr[IEEE802154_LONG_ADDRESS_LEN - 1] |=  (0x02);
