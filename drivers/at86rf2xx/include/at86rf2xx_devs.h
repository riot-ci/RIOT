...
typedef union at86rf2xx_devs {
     ...
     */
    uint8_t mem_devs[
        AT86RF212B_NUM_OF * sizeof(at86rf212b_t) +
        AT86RF231_NUM_OF  * sizeof(at86rf231_t)  +
        AT86RF232_NUM_OF  * sizeof(at86rf232_t)  +
        AT86RF233_NUM_OF  * sizeof(at86rf233_t)  +
        AT86RFA1_NUM_OF   * sizeof(at86rfa1_t)   +
        AT86RFR2_NUM_OF   * sizeof(at86rfr2_t)
    ];
} at86rf2xx_devs_t;

static inline void at86rf2xx_setup_devs(at86rf2xx_devs_t *at86rf2xx_devs)
{
#if IS_USED(MODULE_AT86RF212B)
...
static inline at86rf2xx_t *at86rf2xx_get_dev(at86rf2xx_devs_t *at86rf2xx_devs,
                                             unsigned idx)
{
