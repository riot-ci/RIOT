...
#define AT86RF2XX_TRX_CTRL_0_MASK__CLKM_SHA_SEL                 (0x08) /* all */
#define AT86RF2XX_TRX_CTRL_0_MASK__CLKM_CTRL                    (0x07) /* all */
...
#define AT86RF2XX_TRX_CTRL_2_MASK__FREQ_MODE                    (0x3F) /* Where does this come from? */
...
#define AT86RF2XX_TRX_CTRL_2_MASK__BPSK_OQPSK_MODE              (0x08) /* AT86RF212B */
...
#define AT86RF2XX_IRQ_MASK_MASK_RX_END                          (0x08) /* AT86RFA1, AT86RFR2 */
...
#define AT86RF2XX_XAH_CTRL_2__ARET_FRAME_RETRIES_OFFSET         (0x04)
#define AT86RF2XX_XAH_CTRL_2__ARET_CSMA_RETRIES_OFFSET          (0x01)
/** @} */
