...
int bmp180_init(bmp180_t *dev, const bmp180_params_t *params)
{
    ...
    /* Check sensor ID */
    uint8_t checkid;
    i2c_read_reg(DEV_I2C, BMP180_ADDR, BMP180_REGISTER_ID, &checkid);
    if (checkid != 0x55) {
    ...
    if (i2c_read_regs(DEV_I2C, BMP180_ADDR, BMP180_CALIBRATION_AC1, buffer, 22) < 0) {
...
static int _read_ut(bmp180_t *dev, int32_t *output)
{
    ...
    i2c_write_bytes(DEV_I2C, BMP180_ADDR, control, 2);
    xtimer_usleep(BMP180_ULTRALOWPOWER_DELAY);
    if (i2c_read_regs(DEV_I2C, BMP180_ADDR, BMP180_REGISTER_DATA, ut, 2) < 0) {
...
static int _read_up(bmp180_t *dev, int32_t *output)
{
    ...
    if (i2c_read_regs(DEV_I2C, BMP180_ADDR, BMP180_REGISTER_DATA, up, 3) < 0) {
