...
#define DCF77_PULSE_START_HIGH_THRESHOLD_MICRO_SEC        (1200000U)    /*~1200ms*/
/* Every pulse send by the DCF longer than 130ms is interpreted as 1 */
#define DCF77_PULSE_WIDTH_THRESHOLD_MICRO_SEC              (140000U)    /*~140ms*/
/* If an expected pulse is not detected within 2,5s, something is wrong */
#define DCF77_TIMEOUT_MICRO_SEC                            (2500000U)   /*~2500ms*/
