...
#define DCF77_PULSE_START_HIGH_THRESHOLD_MS     (1200000U)    /*~1200ms*/
/* Every pulse send by the DCF longer than 130ms is interpreted as 1 */
#define DCF77_PULSE_WIDTH_THRESHOLD_MS          (140000U)    /*~140ms*/
    ...
    switch (dev->internal_state) {
        case DCF77_STATE_START:
            ...
            if ((xtimer_now_usec() - dev->startTime) >
                DCF77_PULSE_START_HIGH_THRESHOLD_MS) {
...
static void _level_cb_low(dcf77_t *dev)
{
    switch (dev->internal_state) {
        ...
        case DCF77_STATE_RX:
            ...
            if ((xtimer_now_usec() - dev->startTime) >
                DCF77_PULSE_WIDTH_THRESHOLD_MS) {
