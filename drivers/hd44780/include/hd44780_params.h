...
#define HD44780_PARAM_PIN_RS            GPIO_PIN(PA, 14) /* Arduino D2 */
#endif
#ifndef HD44780_PARAM_PIN_RW
#define HD44780_PARAM_PIN_RW            GPIO_UNDEF
#endif
#ifndef HD44780_PARAM_PIN_ENABLE
#define HD44780_PARAM_PIN_ENABLE        GPIO_PIN(PA, 9) /* Arduino D3 */
#endif
#ifndef HD44780_PARAM_PINS_DATA
#define HD44780_PARAM_PINS_DATA         {   GPIO_PIN(PA, 8),  /* Arduino D4 */  \
                                            GPIO_PIN(PA, 15), /* Arduino D5 */  \
                                            GPIO_PIN(PA, 20), /* Arduino D6 */  \
                                            GPIO_PIN(PA, 21), /* Arduino D7 */  \
                                            GPIO_UNDEF,                         \
                                            GPIO_UNDEF,                         \
                                            GPIO_UNDEF,                         \
                                            GPIO_UNDEF }
