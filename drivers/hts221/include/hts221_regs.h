...
/**
 * @brief   Calibration Register Map
 * @{
 */
...
/**
 * @brief Humidity average over number of samples 4 to 512
 * @{
 */
enum {
...
/**
 * @brief Temperature average over number of samples 2 to 256
 * @{
 */
enum {
...
/**
 * @brief Config bits of HTS221_REGS_CTRL_REG1
 * @{
 */
...
/**
 * @brief Config bits of HTS221_REGS_CTRL_REG2
 * @{
 */
...
/**
 * @brief Data ready config bits of HTS221_REGS_CTRL_REG3
 * @{
 */
...
/**
 * @brief Status bits to check data availability, HTS221_REGS_STATUS_REG[1:0]
 * @{
 */
