...
/**
 * @brief SigFox statuses. See ATA8520 datasheet, section 2.1.2.10, page 9
 */
typedef enum {
...
/**
 * @brief Initialization parameters for ATA8520
 */
typedef struct {
...
/**
 * @brief ATA8520 device descriptor
 */
typedef struct {
