...
/**
 * @defgroup    drivers_ata8520e ATA8520E SigFox transceiver
 * @ingroup     drivers_netdev
 * @brief       Device driver for Microchip ATA8520E SigFox transceiver
 *
 ...
 *
 * See ATA8520E datasheet, section 2.1.2.10, page 9
 */
typedef enum {
 ...
 *
 * @param[in] dev                 Pointer to device descriptor
 * @param[in] payload             The bit to send
 *
 * @return  ATA8520E_OK if the send was successful
 * @return -ATA8520E_ERR_EVENT_TIMEOUT if the send failed
 */
