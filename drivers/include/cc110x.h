...
typedef enum {
    ...
    CC110X_STATE_RX                 = 0b00000001, /**< Listening for frames */
    /**
    ...
    CC110X_STATE_TX                 = 0b00000010, /**< Transmit mode */
    /**
 ...
 * calibration data is stored so that @ref cc110x_hop can skip the calibration
 * phase and use the stored calibration data instead.
 */
 ...
 */
int cc110x_hop(cc110x_t *dev, uint8_t channel);
