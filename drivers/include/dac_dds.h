...
/**
 * @ingroup     drivers_periph_dac DAC Direct Digital Synthesis
 *
 *
 * @{
 * @file
 ...
 *          has been reached.
 *          Should be used to start filling the next sample buffer with @ref dac_dds.
 *
 ...
 */
void dac_dds_init(dac_t dac, uint16_t sample_rate, uint8_t flags,
 ...
 * @param[in] cb_arg        Callback argument
 */
void dac_dds_set_cb(dac_t dac, dac_dds_cb_t cb, void *cb_arg);
 ...
 */
void dac_dds_play(dac_t dac, const void *buf, size_t len);
