 ...
 *
 * @param[in]  dev          device descriptor of sensor
 * @param[out] acc          3-axis acceleration [in 1000 * grativy acceleration (g) ]
 * @param[out] mag          3-axis magnetic field [in 1000 * degree Gauss ]
 *
 * @return                  FXOS8700_OK on success
 * @return                  FXOS8700_BUSERR on I2C communication failures
 */
 ...
 * @param[in]  dev          device descriptor of sensor
 * @param[out] acc          3-axis acceleration [in 1000 * grativy acceleration (g) ]
 * @param[out] mag          3-axis magnetic field [in 1000 * degree Gauss (Gs) ]
 *
 * @return                  FXOS8700_OK on success
 * @return                  FXOS8700_BUSERR on I2C communication failures
 */
