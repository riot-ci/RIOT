 ...
 *
 * @param[in, out]  dev Device handle
 * @param[in]       chs Channel enable flags @see ina3221_enable_ch
 ...
 *
 * @param[in]      dev Device handle
 * @param[out]     chs Pointer to enabled channels variable @see ina3221_enable_ch
 ...
 *
 * @param[in,out]   dev Device handle
 * @param[in]       ech Channel enable flags @see ina3221_enable_ch
 *
 * @return      INA3221_OK, on success
 * @return      -INA3221_I2C_ERROR, if I2C bus acquirement failed
 * @return      @see i2c_read_regs
 ...
 *
 * @param[in]       dev Device handle
 * @param[out]      ech Pointer to enabled channels output variable @see ina3221_enable_ch
 *
 ...
 *
 * @param[in]       dev Device handle
 * @param[in]       esch Enable channel shunt voltage sum flags in host byte order @see ina3221_enable_sum_ch
 *
 * @return      INA3221_OK, on success
 * @return      -INA3221_I2C_ERROR, if I2C bus acquirement failed
 * @return      @see i2c_read_regs
 ...
 *
 * @param[in]       dev Device handle
 * @param[out]      esch Pointer to enabled channels for shunt voltage sum calculation output variable @see ina3221_enable_sum_ch
 *
