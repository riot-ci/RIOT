 ...
 */
/**
 * @defgroup    drivers_nrf24l01p NRF24L01+ 2.4 GHz trasceiver driver
 * @ingroup     drivers_netdev
 *
 * This module contains the driver for the NRF24L01+ 2.4 GHz
 * transceiver.
 *
 * @{
 * @file
 * @brief   Public interface for NRF24L01+ devices
 *
...
/**
 * @brief Pass the compiler a definition of NRF24L01P_ADDR_WIDTH to configure
 *        the layer-2 address width of this transceiver.
 */
#ifndef NRF24L01P_ADDR_WIDTH
#define NRF24L01P_ADDR_WIDTH                NRF24L01P_MAX_ADDR_WIDTH
#elif (NRF24L01P_ADDR_WIDTH < NRF24L01P_MIN_ADDR_WIDTH) || \
      (NRF24L01P_ADDR_WIDTH > NRF24L01P_MAX_ADDR_WIDTH)
#error "NRF24L01P_ADDR_WIDTH must be within [3, 5]"
#endif
...
typedef struct {
    ...
    union {
        struct {
             ...
             */
            uint8_t rx_addr_long[2][NRF24L01P_ADDR_WIDTH];
            /**
        ...
        struct {
             ...
             */
            uint8_t rx_p0[NRF24L01P_ADDR_WIDTH];
            /**
             * @brief   pipe 1 Rx address
             */
            uint8_t rx_p1[NRF24L01P_ADDR_WIDTH];
            /**
 ...
 *
 * For pipe 0 and 1 NRF24L01P_ADDR_WIGTH bytes are expected
 *
 * @param[in] dev           NRF24L01+ device handle
 ...
 *
 * @p addr must be at least NRF24L01P_ADDR_WIDTH wide.
 *
 * @param[in] dev           NRF24L01+ device handle
