 ...
 * ((1 / 24 Hz) * 3 cycles)
 */
#define BLINKING_PERIOD_125_MS  3
 ...
 * ((1 / 24 Hz) * 6 cycles)
 */
#define BLINKING_PERIOD_250_MS  6
 ...
 * ((1 / 24 Hz) * 12 cycles)
 */
#define BLINKING_PERIOD_500_MS  12
 ...
 * ((1 / 24 Hz) * 24 cycles)
 */
#define BLINKING_PERIOD_1_S     24

/**
 * @brief Blinking period with a maximum duration of ~10.73 s
 */
#define BLINKING_PERIOD_MAX     255
