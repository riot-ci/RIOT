 ...
 * or any other hardware component which provides GPIOs such as GPIO extenders.
 * This interface is intentionally designed to be as simple as possible, to
 * allow for easy implementation and maximum portability.
 *
 * The interface provides capabilities to initialize a pin as output-,
