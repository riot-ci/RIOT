...
typedef struct {
    ...
    uint8_t rx2_dr;                    /**< Datarate used for second receive window */
    uint8_t tx_port;                   /**< Application TX port (between 1 and 223) */
    uint8_t tx_mode;                   /**< TX mode, either confirmable of unconfirmable */
 ...
 * @return                  RN2XX3_ERR_MAC_PAUSEED if MAC layed is paused
 ...
 */
void rn2xx3_mac_set_dev_eui(rn2xx3_t *dev, uint8_t *eui);
 ...
 */
void rn2xx3_mac_get_app_eui(rn2xx3_t *dev, uint8_t *eui);
 ...
 */
void rn2xx3_mac_set_app_eui(rn2xx3_t *dev, uint8_t *eui);
 ...
 */
void rn2xx3_mac_set_app_key(rn2xx3_t *dev, uint8_t *key);
 ...
 */
void rn2xx3_mac_get_dev_addr(rn2xx3_t *dev, uint8_t *addr);
 ...
 */
void rn2xx3_mac_set_dev_addr(rn2xx3_t *dev, uint8_t *addr);

/**
 * @brief   Gets the rn2xx3 LoRaMAC TX radio power
 *
 * @param[in] dev                      The rn2xx3 device descriptor
 *
 * @return                             The radio power
 */
uint8_t rn2xx3_mac_get_tx_power(rn2xx3_t *dev);

/**
 * @brief   Sets the rn2xx3 LoRaMAC transmission power
 *
 * @param[in] dev                      The rn2xx3 device descriptor
 * @param[in] power                    The TX power
 */
void rn2xx3_mac_set_tx_power(rn2xx3_t *dev, uint8_t power);
 ...
 * @return                             The datarate
 */
uint8_t rn2xx3_mac_get_dr(rn2xx3_t *dev);
 ...
 */
void rn2xx3_mac_set_dr(rn2xx3_t *dev, uint8_t dr);
 ...
 *
 * @param[in] dev                      The rn2xx3 device descriptor
 * @param[in] retx                     The link check interval in seconds
 */
 ...
 *
 * @param[in] dev                      The rn2xx3 device descriptor
 * @param[in] rx2                      The automatic reply state
 */
 ...
 */
uint8_t rn2xx3_mac_get_rx2_dr(rn2xx3_t *dev);
 ...
 */
void rn2xx3_mac_set_rx2_dr(rn2xx3_t *dev, uint8_t dr);
 ...
 */
uint8_t rn2xx3_mac_get_tx_mode(rn2xx3_t *dev);
