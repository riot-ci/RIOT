 ...
 * accessing the device. Finally, the SAUL information is only used when
 * accessing the sensor via SAUL, and contains the semantic information, such as
 * physical unit of the values, a name of the sensor, and scale information.
 *
 * A custom conversion function can be supplied to convert the value read from
 * raw bits and bytes into something more usable.
 *
 * @{
 *
 * @file
