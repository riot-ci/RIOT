...
/**
 * @defgroup    drivers_si114x Si114x
 * @ingroup     drivers_sensors
 * @brief       Device driver interface for the Si1145/6/7 sensors family
 * @{
 *
 * @file
...
/**
 * @brief Initialisation return codes
 */
typedef enum {
    SI114X_OK,
    SI114X_ERR_I2C,
...
/**
 * @brief Read distance measure from the given Si114x device, returned in m
 *
 * @param[in]  dev          Device descriptor of Si114x device to read from
 *
