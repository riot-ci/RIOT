...
int8_t mrf24j40_get_ed_level(mrf24j40_t *dev)
{
    ...
    while (rssi_rdy != MRF24J40_BBREG2_RSSIRDY) {
        rssi_rdy = mrf24j40_reg_read_short(dev, MRF24J40_REG_BBREG6);
        rssi_rdy &= MRF24J40_BBREG2_RSSIRDY;
    }

    uint8_t rssi = mrf24j40_reg_read_long(dev, MRF24J40_REG_RSSI);

    mrf24j40_reg_write_short(dev, MRF24J40_REG_BBREG6, bbreg6);
