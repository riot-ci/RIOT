...
#ifndef NRF24L01P_PARAM_SPI_SPEED
/**
 * @brief   SPI clock speed
 */
#define NRF24L01P_PARAM_SPI_SPEED           SPI_CLK_5MHZ
#endif

#ifndef NRF24L01P_PARAM_PIN_CS
/**
 * @brief   SPI CS gpio pin
 */
#define NRF24L01P_PARAM_PIN_CS              GPIO_UNDEF
#endif

#ifndef NRF24L01P_PARAM_PIN_CE
/**
 * @brief   NRF24L01P chip enable gpio pin
 */
#define NRF24L01P_PARAM_PIN_CE              GPIO_UNDEF
#endif

#ifndef NRF24L01P_PARAM_PIN_IRQ
/**
 * @brief   NRF24L01P interrupt gpio pin
 */
#define NRF24L01P_PARAM_PIN_IRQ             GPIO_UNDEF
#endif
...
#define NRF24L01P_PARAMS    {                                                  \
        ...
        .spi_clk = NRF24L01P_PARAM_SPI_SPEED,                                  \
        .pin_cs = NRF24L01P_PARAM_PIN_CS,                                      \
        .pin_ce = NRF24L01P_PARAM_PIN_CE,                                      \
        .pin_irq = NRF24L01P_PARAM_PIN_IRQ,                                    \
        .urxaddr.rxaddrpx = {                                                  \
