 ...
 *
 * @file
 * @brief   Definitions of user visible types for the NRF24L01+ device driver
 *
 ...
 */
#define NRF24L01P_TRANSITION_TO_POWER_DOWN  (1 << 3)
/**
 * @brief   Flag that indicates that a state transition to
 *          STANDBY_1 can be done
 */
#define NRF24L01P_TRANSITION_TO_STANDBY_1   (1 << 4)
/**
 * @brief   Flag that indicates that a state transition to
 *          STANDBY_2 can be done
 */
#define NRF24L01P_TRANSITION_TO_STANDBY_2   (1 << 5)
/**
 * @brief   Flag that indicates that a state transition to
 *          RX_MODE can be done
 */
#define NRF24L01P_TRANSITION_TO_RX_MODE     (1 << 6)
/**
 * @brief   Flag that indicates that a state transition to
 *          TX_MODE can be done
 */
#define NRF24L01P_TRANSITION_TO_TX_MODE     (1 << 7)
...
typedef enum nrf24l01p_state {
    ...
    NRF24L01P_STATE_UNDEFINED  = (0 | (NRF24L01P_TRANSITION_TO_POWER_DOWN)),
    /** @brief Register values are available and maintained, SPI active */
    NRF24L01P_STATE_POWER_DOWN = (1 | (NRF24L01P_TRANSITION_TO_STANDBY_1)),
    /** @brief Idle */
    NRF24L01P_STATE_STANDBY_1  = (2 | (NRF24L01P_TRANSITION_TO_POWER_DOWN |
                                       NRF24L01P_TRANSITION_TO_STANDBY_2  |
                                       NRF24L01P_TRANSITION_TO_RX_MODE    |
                                       NRF24L01P_TRANSITION_TO_TX_MODE)),
    /** @brief TX FIFO empty, fill up TX FIFO again */
    NRF24L01P_STATE_STANDBY_2  = (3 | (NRF24L01P_TRANSITION_TO_POWER_DOWN |
                                       NRF24L01P_TRANSITION_TO_TX_MODE)),
    /** @brief Constantly search for a valid packet */
    NRF24L01P_STATE_RX_MODE    = (4 | (NRF24L01P_TRANSITION_TO_POWER_DOWN |
                                       NRF24L01P_TRANSITION_TO_STANDBY_1)),
    /** @brief Transmit next packet */
    NRF24L01P_STATE_TX_MODE    = (5 | (NRF24L01P_TRANSITION_TO_POWER_DOWN |
                                       NRF24L01P_TRANSITION_TO_STANDBY_1  |
                                       NRF24L01P_TRANSITION_TO_STANDBY_2)),
} nrf24l01p_state_t;
...
typedef enum nrf24l01p_tx_power {
    ...
    NRF24L01P_TX_POWER_NUM_OF           /**< Number of possible values
