 ...
 */
#define NRF24L01P_NG_FLG_MASK_RX_DR         (0b01000000)
/**
 ...
 */
#define NRF24L01P_NG_FLG_MASK_TX_DS         (0b00100000)
/**
 ...
 */
#define NRF24L01P_NG_FLG_MASK_MAX_RT        (0b00010000)
/**
 ...
 * @brief   Flag: EN_CRC
 */
#define NRF24L01P_NG_FLG_EN_CRC             (0b00001000)
/**
 ...
 */
#define NRF24L01P_NG_FLG_CRCO_1_BYTE        (0b00000000)
/**
 * @brief   Flag: CRCO - 2 byte
 */
#define NRF24L01P_NG_FLG_CRCO_2_BYTE        (0b00000100)
/**
 * @brief   Mask to configure CRC
 */
#define NRF24L01P_NG_MSK_CRC                (0b00001100)
/**
 * @brief    Flag: CRCO
 */
 ...
 * @brief   Flag: PWR_UP
 */
#define NRF24L01P_NG_FLG_PWR_UP             (0b00000010)
/**
 ...
 * @brief   Flag: PRIM_RX
 */
#define NRF24L01P_NG_FLG_PRIM_RX            (0b00000001)
/**
 ...
 * @brief   Flag: ENAA_P5
 */
#define NRF24L01P_NG_FLG_ENAA_P5            (0b00100000)
/**
 ...
 * @brief Flag: ENAA_P4
 */
#define NRF24L01P_NG_FLG_ENAA_P4            (0b00010000)
/**
 ...
 * @brief   Flaga: ENAA_P3
 */
#define NRF24L01P_NG_FLG_ENAA_P3            (0b00001000)
/**
 ...
 * @brief   Flag: ENAA_P2
 */
#define NRF24L01P_NG_FLG_ENAA_P2            (0b00000100)
/**
 ...
 * @brief   Flag: ENAA_P1
 */
#define NRF24L01P_NG_FLG_ENAA_P1            (0b00000010)
/**
 ...
 * @brief   Flag: ENAA_P0
 */
#define NRF24L01P_NG_FLG_ENAA_P0            (0b00000001)
/**
 ...
 * @brief   Flag: ERX_P5
 */
#define NRF24L01P_NG_FLG_ERX_P5             (0b00100000)
/**
 ...
 * @brief   Flag: ERX_P4
 */
#define NRF24L01P_NG_FLG_ERX_P4             (0b00010000)
/**
 ...
 * @brief   Flag: ERX_P3
 */
#define NRF24L01P_NG_FLG_ERX_P3             (0b00001000)
/**
 ...
 * @brief   Flag: ERX_P2
 */
#define NRF24L01P_NG_FLG_ERX_P2             (0b00000100)
/**
 ...
 * @brief   Flag: ERX_P1
 */
#define NRF24L01P_NG_FLG_ERX_P1             (0b00000010)
/**
 ...
 * @brief   Flag: ERX_P0
 */
#define NRF24L01P_NG_FLG_ERX_P0             (0b00000001)
/**
 ...
 */
#define NRF24L01P_NG_FLG_AW_3               (0b00000001)
/**
 * @brief   Flag: AW - 4 bytes
 */
#define NRF24L01P_NG_FLG_AW_4               (0b00000010)
/**
 * @brief   Flag: AW - 5 bytes
 */
#define NRF24L01P_NG_FLG_AW_5               (0b00000011)
/**
 * @brief   Mask to configure AW
 */
#define NRF24L01P_NG_MSK_AW                 (0b00000011)
/**
 ...
 */
#define NRF24L01P_NG_FLG_ARD_250_US         (0b00000000)
/**
 * @brief   Flag: ARD - 500 us
 */
#define NRF24L01P_NG_FLG_ARD_500_US         (0b00010000)
/**
 * @brief   Flag: ARD - 750 us
 */
#define NRF24L01P_NG_FLG_ARD_750_US         (0b00100000)
/**
 * @brief   Flag: ARD - 1000 us
 */
#define NRF24L01P_NG_FLG_ARD_1000_US        (0b00110000)
/**
 * @brief   Flag: ARD - 1250 us
 */
#define NRF24L01P_NG_FLG_ARD_1250_US        (0b01000000)
/**
 * @brief   Flag: ARD - 1500 us
 */
#define NRF24L01P_NG_FLG_ARD_1500_US        (0b01010000)
/**
 * @brief   Flag: ARD - 1750 us
 */
#define NRF24L01P_NG_FLG_ARD_1750_US        (0b01100000)
/**
 * @brief   Flag: ARD - 2000 us
 */
#define NRF24L01P_NG_FLG_ARD_2000_US        (0b01110000)
/**
 * @brief   Flag: ARD - 2250 us
 */
#define NRF24L01P_NG_FLG_ARD_2250_US        (0b10000000)
/**
 * @brief   Flag: ARD - 2500 us
 */
#define NRF24L01P_NG_FLG_ARD_2500_US        (0b10010000)
/**
 * @brief   Flag: ARD - 2750 us
 */
#define NRF24L01P_NG_FLG_ARD_2750_US        (0b10100000)
/**
 * @brief   Flag: ARD - 3000 us
 */
#define NRF24L01P_NG_FLG_ARD_3000_US        (0b10110000)
/**
 * @brief   Flag: ARD - 3250 us
 */
#define NRF24L01P_NG_FLG_ARD_3250_US        (0b11000000)
/**
 * @brief   Flag: ARD - 3500 us
 */
#define NRF24L01P_NG_FLG_ARD_3500_US        (0b11010000)
/**
 * @brief   Flag: ARD - 3750 us
 */
#define NRF24L01P_NG_FLG_ARD_3750_US        (0b11100000)
/**
 * @brief   Flag: ARD - 4000 us
 */
#define NRF24L01P_NG_FLG_ARD_4000_US        (0b11110000)
/**
 * @brief   Mask to configure ARD
 */
#define NRF24L01P_NG_MSK_ARD                (0b11110000)
/**
 ...
 */
#define NRF24L01P_NG_MSK_ARC                (0b00001111)
/**
 ...
 */
#define NRF24L01P_NG_MSK_RF_CH              (0b01111111)
/**
 ...
 */
#define NRF24L01P_NG_FLG_CONT_WAVE          (0b10000000)
/**
 ...
 */
#define NRF24L01P_NG_FLG_RF_DR_LOW          (0b00100000)
/**
 ...
 * @brief   Flag: PLL_LOCK
 */
#define NRF24L01P_NG_FLG_PLL_LOCK           (0b00010000)
/**
 ...
 */
#define NRF24L01P_NG_FLG_RF_DR_HIGH         (0b00001000)
/**
 ...
 */
#define NRF24L01P_NG_FLG_RF_DR_250_KBPS     (0b00001000)
/**
 * @brief   Flag: RF_DR - 1000 kbit/s
 */
#define NRF24L01P_NG_FLG_RF_DR_1_MBPS       (0b00000000)
/**
 * @brief   Flag: RF_DR - 2000 kbit/s
 */
#define NRF24L01P_NG_FLG_RF_DR_2_MBPS       (0b00100000)
/**
 * @brief   Mask to configure RF_DR
 */
#define NRF24L01P_NG_MSK_RF_DR              (0b00101000)
/**
 * @brief   FLG RF_DR
 */
 ...
 */
#define NRF24L01P_NG_FLG_RF_PWR_MINUS_18    (0b00000000)
/**
 * @brief   Flag: RF_PWR - -12 dbm
 */
#define NRF24L01P_NG_FLG_RF_PWR_MINUS_12    (0b00000010)
/**
 * @brief   Flag: RF_PWR - -6 dbm
 */
#define NRF24L01P_NG_FLG_RF_PWR_MINUS_6     (0b00000100)
/**
 * @brief   Flag: RF_PWR - 0 dbm
 */
#define NRF24L01P_NG_FLG_RF_PWR_0           (0b00000110)
/**
 * @brief   Mask to configure RF_PWR
 */
#define NRF24L01P_NG_MSK_RF_PWR             (0b00000110)
/**
 ...
 * @brief   Flag: RX_DR
 */
#define NRF24L01P_NG_FLG_RX_DR              (0b01000000)
/**
 ...
 * @brief   Flag: TX_DS
 */
#define NRF24L01P_NG_FLG_TX_DS              (0b00100000)
/**
 ...
 * @brief   Flag: MAX_RT
 */
#define NRF24L01P_NG_FLG_MAX_RT             (0b00010000)
/**
 ...
 */
#define NRF24L01P_NG_FLG_RX_P_NO_NONE      (0b00001110)
/**
 * @brief   Mask to read RX_P_NO
 */
#define NRF24L01P_NG_MSK_RX_P_NO            (0b00001110)
/**
 ...
 * @brief   Flag: TX_FULL
 */
#define NRF24L01P_NG_FLG_TX_FULL            (0b00000001)
/**
 ...
 */
#define NRF24L01P_NG_MSK_PLOS_CNT           (0b11110000)
/**
 ...
 */
#define NRF24L01P_NG_MSK_ARC_CNT            (0b00001111)
/**
 ...
 * @brief   Flag: RPD
 */
#define NRF24L01P_NG_FLG_RPD                (0b00000001)
/**
 * @brief   Value of: RPD
 */
 ...
 */
#define NRF24L01P_NG_MSK_RX_PW_PX           (0b0011111)
/**
 ...
 * @brief   Flag: TX_REUSE
 */
#define NRF24L01P_NG_FLG_TX_REUSE           (0b01000000)
/**
 ...
 */
#define NRF24L01P_NG_FLG_TX_FULL_           (0b00100000)
/**
 * @brief   Value of: TX_FULL
 */
 ...
 * @brief   Flag: TX_EMPTY
 */
#define NRF24L01P_NG_FLG_TX_EMPTY           (0b00010000)
/**
 ...
 * @brief   Flag: RX_FULL
 */
#define NRF24L01P_NG_FLG_RX_FULL            (0b00000010)
/**
 ...
 * @brief   Flag: RX_EMPTY
 */
#define NRF24L01P_NG_FLG_RX_EMPTY           (0b00000001)
/**
 ...
 * @brief   Flag: DPL_P5
 */
#define NRF24L01P_NG_FLG_DPL_P5             (0b00100000)
/**
 ...
 * @brief   Flag: DPL_P4
 */
#define NRF24L01P_NG_FLG_DPL_P4             (0b00010000)
/**
 ...
 * @brief   Flag: DPL_P3
 */
#define NRF24L01P_NG_FLG_DPL_P3             (0b00001000)
/**
 ...
 * @brief   Flag: DPL_P2
 */
#define NRF24L01P_NG_FLG_DPL_P2             (0b00000100)
/**
 ...
 * @brief   Flag: DPL_P1
 */
#define NRF24L01P_NG_FLG_DPL_P1             (0b00000010)
/**
 ...
 * @brief   Flag: DPL_P0
 */
#define NRF24L01P_NG_FLG_DPL_P0             (0b00000001)
/**
 ...
 * @brief   Flag: EN_DPL
 */
#define NRF24L01P_NG_FLG_EN_DPL             (0b00000100)
/**
 ...
 */
#define NRF24L01P_NG_FLG_EN_ACK_PAY         (0b00000010)
/**
 ...
 */
#define NRF24L01P_NG_FLG_EN_DYN_ACK         (0b00000001)
/**
