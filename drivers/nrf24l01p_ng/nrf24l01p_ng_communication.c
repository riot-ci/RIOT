 ...
 *
 */
static void _swap_bytes(uint8_t* buffer, size_t len) {
...
static void _copy_and_swap_bytes(uint8_t* dst, const uint8_t* src, size_t len) {
                               ...
                               const uint8_t *src, size_t len)
{
    ...
    if (len > 1) {
        ...
        _copy_and_swap_bytes(lsrc, src, len);
