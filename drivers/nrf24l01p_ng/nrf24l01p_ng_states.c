...
{
    DEBUG("[nrf24l01p_ng] transition to POWER_DOWN\n");
...
{
    DEBUG("[nrf24l01p_ng] transition to STANDBY_1\n");
...
{
    DEBUG("[nrf24l01p_ng] transition to STANDBY_2\n");
...
{
    DEBUG("[nrf24l01p_ng] transition to RX_MODE\n");
...
{
    DEBUG("[nrf24l01p_ng] transition to TX_MODE\n");
