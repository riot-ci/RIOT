...
int8_t si114x_init(si114x_t *dev, const si114x_params_t * params)
{
    ...
    /* check sensor ID */
    char checkid = 0;
    i2c_read_reg(dev->params.i2c_dev, SI114X_ADDR, SI114X_REG_PART_ID, &checkid);
...
uint16_t si114x_read_uv(si114x_t *dev)
{
    ...
    uint8_t buffer[2];
    i2c_read_regs(dev->params.i2c_dev, SI114X_ADDR,
...
void _reset(si114x_t *dev)
{
    ...
    i2c_write_reg(dev->params.i2c_dev, SI114X_ADDR,
...
void _set_param(si114x_t *dev, uint8_t param, uint8_t value)
{
    ...
    uint8_t ret;
    i2c_read_reg(dev->params.i2c_dev, SI114X_ADDR,
