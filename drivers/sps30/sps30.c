...
#define SPS30_CRC_POLY       (0x31) /**< Polynomial for the CRC calulation */
#define SPS30_CRC_INIT       (0xFF) /**< Init value for the CRC calulation */
...
bool sps30_data_ready(const sps30_t *dev, int *error)
{
    ...
    return res == SPS30_OK ? data[1] : false;
}
