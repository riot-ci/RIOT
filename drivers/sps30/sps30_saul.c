...
static int do_read(const void *dev, phydat_t *data, unsigned int val_idx)
{
...
{
    return do_read(dev, data, SPS30_SAUL_VAL_IDX_MC_PM_1_2P5_4);
}

static int read_mc_pm_10(const void *dev, phydat_t *data)
{
    return do_read(dev, data, SPS30_SAUL_VAL_IDX_MC_PM_10);
}

static int read_nc_pm_0p5_1_2p5(const void *dev, phydat_t *data)
{
    return do_read(dev, data, SPS30_SAUL_VAL_IDX_NC_PM_0P5_1_2P5);
}

static int read_nc_pm_4_10(const void *dev, phydat_t *data)
{
    return do_read(dev, data, SPS30_SAUL_VAL_IDX_NC_PM_4_10);
}

static int read_ps(const void *dev, phydat_t *data)
{
    return do_read(dev, data, SPS30_SAUL_VAL_IDX_PS);
}
