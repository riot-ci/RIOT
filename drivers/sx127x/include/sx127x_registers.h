...
/**
 * @brief SX127X Internal registers Addresses
 * @{
 */
...
/**
 * @brief Modem settings for random number generator
 * @{
 */
...
/**
 * @brief SX127X LoRa bits control definition
 * @{
 */
...
/**
 * @brief SX127X Internal registers Address
 * @{
 */
...
/**
 * @brief SX127X FSK bits control definition
 * @{
 */
