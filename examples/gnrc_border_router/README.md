...
This requires the border router to have two interfaces, a downstream, 6lo-interface
and an IPv6 uplink.
...
As said previously, `ethos` and `slip` allow to send IP packets and shell commands.
