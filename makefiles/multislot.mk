ifneq (,$(filter mcuboot create-key flash-bootloader flash-mcuboot link, $(MAKECMDGOALS)))
ifdef SLOT0_SIZE
...
ifneq (,$(filter multislot combined flash-multislot keys verify bootloader multislot-clean link, $(MAKECMDGOALS)))
