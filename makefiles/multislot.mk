...
SLOT1_ADDR = $(shell echo 'obase=16; ${SLOT0_SIZE_DEC}+${FIRMWARE_METADATA_SIZE_DEC}' | bc)
SLOT2_ADDR = $(shell echo 'obase=16; ${SLOT0_SIZE_DEC}+${SLOT1_SIZE_DEC}+${FIRMWARE_METADATA_SIZE_DEC}' | bc)
