...
void nimble_statconn_init(void)
{
    ...
    _conn_params.scan_itvl = ((NIMBLE_STATCONN_CONN_WIN * 1000) / BLE_HCI_SCAN_ITVL);
    _conn_params.scan_window = ((NIMBLE_STATCONN_CONN_WIN * 1000) / BLE_HCI_SCAN_ITVL);
    _conn_params.itvl_min = ((NIMBLE_STATCONN_CONN_ITVL * 1000) / BLE_HCI_CONN_ITVL);
    _conn_params.itvl_max = ((NIMBLE_STATCONN_CONN_ITVL * 1000) / BLE_HCI_CONN_ITVL);
    _conn_params.latency = NIMBLE_STATCONN_CONN_LATENCY;
    _conn_params.supervision_timeout = (NIMBLE_STATCONN_CONN_SUPER_TO / 10);
    _conn_params.min_ce_len = 0;
    _conn_params.max_ce_len = 0;
    _conn_timeout = NIMBLE_STATCONN_CONN_TIMEOUT;
