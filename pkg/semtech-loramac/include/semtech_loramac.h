 ...
 */
typedef struct {
    sx127x_t sx127x;                             /**< sx127x device descriptor */
 ...
 *
 * @param[in] dev          Pointer to loramac descriptor
 *
 * @return  0 on success
 * @return -1 on failure
 */
 ...
 *
 * @param[in] mac          Pointer to the mac
 * @param[in] power        The TX application port
 */
...
/**
 * @brief   Sets the RX2 window parameters
 *
 * The parameters are channel frequency and datarate. They are passed together
 * to the mac.
 *
 * @param[in] mac          Pointer to the mac
 * @param[in] params       The RX2 channel parameters
 */
