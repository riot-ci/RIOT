...
/**
 * @brief global cdc eem object, declared in the usb auto init file
 */
...
extern void cdcecm_netdev_setup(usbus_cdcecm_device_t *cdceem);
...
void auto_init_netdev_cdcecm(void)
{
    ...
    gnrc_netif_ethernet_create(_netdev_eth_stack, CDCECM_MAC_STACKSIZE,
                               CDCECM_MAC_PRIO, "cdcecm", (netdev_t *)&cdcecm.netdev);
}
