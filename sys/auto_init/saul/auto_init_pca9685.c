 ...
 */
#define PCA9685_NUM    (sizeof(pca9685_params) / sizeof(pca9685_params[0]))

/**
 * @brief   Number of configured SAUL PCA9685 DAC channels
 */
#define PCA9685_SAUL_DAC_NUMOF (sizeof(pca9685_saul_pwm_params) / \
                                sizeof(pca9685_saul_pwm_params[0]))

/**
 * @brief   Number of saul info
 */
#define PCA9685_INFO_NUM    (sizeof(pca9685_saul_info) / \
                             sizeof(pca9685_saul_info[0]))
