...
/**
 * @name   Define the number of configured sensors
 */
#define SI114X_NUMOF    (sizeof(si114x_params) / sizeof(si114x_params[0]))

/**
 * @name   Allocation of memory for device descriptors
 */
static si114x_t si114x_devs[SI114X_NUMOF];

/**
 * @name   Memory for the SAUL registry entries
 */
static saul_reg_t saul_entries[SI114X_NUMOF * 4];

/**
 * @name   Define the number of saul info
 */
