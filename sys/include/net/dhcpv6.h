...
#define DHCPV6_OPT_UNICAST          (12U)   /**< server unicast option */
...
#define DHCPV6_STATUS_UNSPECFAIL    (1U)    /**< UnspecFail */
#define DHCPV6_STATUS_NOADDRAVAIL   (2U)    /**< NoAddrsAvail */
#define DHCPV6_STATUS_NOBINDING     (3U)    /**< NoBinding */
#define DHCPV6_STATUS_NOTONLINK     (4U)    /**< NotOnLink */
#define DHCPV6_STATUS_USEMULTICAST  (5U)    /**< UseMulticast */
#define DHCPV6_STATUS_NOPREFIXAVAIL (6U)    /**< NoPrefixAvail */
/** @} */
...
#define DHCPV6_CNF_MAX_DELAY        (1U)    /**< CNF_MAX_DELAY (in sec) */
#define DHCPV6_CNF_TIMEOUT          (1U)    /**< CNF_TIMEOUT (in sec) */
#define DHCPV6_CNF_MAX_RT           (4U)    /**< CNF_MAX_RT (in sec) */
#define DHCPV6_CNF_MAX_RD           (10U)   /**< CNF_MAX_RD (in sec) */
...
#define DHCPV6_REL_TIMEOUT          (1U)    /**< REL_TIMEOUT (in sec) */
#define DHCPV6_REL_MAX_RC           (4U)    /**< REL_MAX_RC */

#define DHCPV6_DEC_TIMEOUT          (1U)    /**< DEC_TIMEOUT (in sec) */
#define DHCPV6_DEC_MAX_RC           (4U)    /**< DEC_MAX_RC */

#define DHCPV6_MAX_WAIT_TIME        (60U)   /**< MAX_WAIT_TIME (in sec) */
/** @} */
 ...
 * @{
 */
#define DHCPV6_DUID_TYPE_L2T        (1U)    /**< Link-layer address plus time */
#define DHCPV6_DUID_TYPE_EN         (2U)    /**< Vendor-assigned unique ID */
#define DHCPV6_DUID_TYPE_L2         (3U)    /**< Link-layer address */
#define DHCPV6_DUID_TYPE_UUID       (4U)    /**< UUID (see RFC6355) */
/** @} */
...
/**
 * @brief   DHCPv6 server unicast option format
 * @see [draft-ietf-dhc-rfc3315bis-12, section 21.12]
 *      (https://tools.ietf.org/html/draft-ietf-dhc-rfc3315bis-12#section-21.12)
 */
typedef struct __attribute__((packed)) {
    network_uint16_t type;          /**< @ref DHCPV6_OPT_UNICAST */
    network_uint16_t len;           /**< always 16 */
    ipv6_addr_t server_addr;        /**< server unicast address */
} dhcpv6_opt_unicast_t;
