...
/**
 * @defgroup    net_gnrc_ipv6_nib   Networking Information Base for IPv6
 * @ingroup     net_gnrc_ipv6
 * @brief       Network Information Base for IPv6
 *
 ...
 * pointer to a valid [on-link entry](@ref _nib_t) representing the neighbor
 * that sent the Router Solicitation.
 *
 ...
 * [on-link entry](@ref _nib_t) representing the neighbor cache entry that faces
 * a state change.
 *
 ...
 * [on-link entry](@ref _nib_t) representing the neighbor which faces a timeout
 * of its address registration
 *
