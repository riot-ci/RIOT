 ...
 *
 * **This number has direct influence on the max. number of default routers**
 */
 ...
 *
 * **This number has direct influence on the max. number of neighbors and
 * duplicate address detection table entries**
 */
