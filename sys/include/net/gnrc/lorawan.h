 ...
 *        @ref gnrc_lorawan_save_cb will be called.
 *
 ...
 *
 * @param pos Position where to save a chunk of memory in the storage
 ...
 *
 * @param pos Position where to read a chunk of memory from the storage
 * @param buf Buffer containing internal MAC state to be saved.
 * @param len Number of bytes to be saved
 *
