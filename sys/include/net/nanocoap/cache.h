 ...
 */
#if IS_USED(MODULE_NANOCOAP_CACHE)
int nanocoap_cache_process(const uint8_t *cache_key, const coap_pkt_t *resp,
                           size_t resp_len);
#else
static inline int
nanocoap_cache_process(const uint8_t *cache_key, const coap_pkt_t *resp,
                       size_t resp_len)
{
    (void) cache_key;
    (void) resp;
...
nanocoap_cache_entry_t *nanocoap_cache_add_by_req(const coap_pkt_t *req,
                                                  ...
                                                  size_t resp_len);
#else
static inline nanocoap_cache_entry_t *
nanocoap_cache_add_by_req(const coap_pkt_t *req,
                          const coap_pkt_t *resp,
                          size_t resp_len)
{
    (void) req;
...
#else
static inline nanocoap_cache_entry_t *
nanocoap_cache_add_by_key(const uint8_t *cache_key,
                          const coap_pkt_t *resp,
                          size_t resp_len)
{
    (void) cache_key;
...
#else
static inline nanocoap_cache_entry_t *
nanocoap_cache_request_lookup(const coap_pkt_t *req)
{
    (void) req;
    return NULL;
}
...
#else
static inline nanocoap_cache_entry_t *
nanocoap_cache_key_lookup(const uint8_t *cache_key)
{
    (void) cache_key;
    return NULL;
}
...
#else
static inline int nanocoap_cache_del(const nanocoap_cache_entry_t *ce)
{
    (void) ce;
    return -1;
}
...
#else
static inline void
nanocoap_cache_key_generate(const coap_pkt_t *req, uint8_t *cache_key)
{
    (void) req;
    (void) cache_key;
    return;
