...
/**
 * @brief   Function to handle failed expection
 *
 * @note    This function was introduced for memory size optimization
 *
 * @warning this function **NEVER** returns!
 *
 * @param[in] file  The file name of the file the expection failed in
 * @param[in] line  The code line of @p file the expection failed in
 */
NORETURN static inline void _expect_failure(const char *file, unsigned line, const char *cond)
{
 ...
 *
 */
#define expect(cond) ((cond) ? (void)0 :  _expect_failure(RIOT_FILE_RELATIVE, __LINE__, #cond))
