...
#else
#define FATFS_DIR_BUFFER_SIZE       (1)
#define FATFS_FILE_BUFFER_SIZE      (1)
#endif
/** @} */
...
#else
#define LITTLEFS_DIR_BUFFER_SIZE    (1)
#define LITTLEFS_FILE_BUFFER_SIZE   (1)
#endif
/** @} */
...
#else
#define LITTLEFS2_DIR_BUFFER_SIZE   (1)
#define LITTLEFS2_FILE_BUFFER_SIZE  (1)
#endif
/** @} */
...
#else
#define SPIFFS_DIR_BUFFER_SIZE      (1)
#define SPIFFS_FILE_BUFFER_SIZE     (1)
#endif
/** @} */
