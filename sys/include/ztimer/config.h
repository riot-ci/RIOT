 ...
 */
        ...
        #define CONFIG_ZTIMER_TIMER_REQUIRED_PM_MODE CONFIG_ZTIMER_USEC_REQUIRED_PM_MODE
    #else
        #define CONFIG_ZTIMER_TIMER_REQUIRED_PM_MODE ZTIMER_CLOCK_NO_REQUIRED_PM_MODE
    #endif
#endif
 ...
 */
#ifndef CONFIG_ZTIMER_RTT_REQUIRED_PM_MODE
    #ifdef CONFIG_ZTIMER_MSEC_REQUIRED_PM_MODE
        #define CONFIG_ZTIMER_RTT_REQUIRED_PM_MODE CONFIG_ZTIMER_MSEC_REQUIRED_PM_MODE
    #else
        #define CONFIG_ZTIMER_RTT_REQUIRED_PM_MODE ZTIMER_CLOCK_NO_REQUIRED_PM_MODE
    #endif
#endif
 ...
 */
#ifndef CONFIG_ZTIMER_RTC_REQUIRED_PM_MODE
    #ifdef CONFIG_ZTIMER_SEC_REQUIRED_PM_MODE
        #define CONFIG_ZTIMER_RTC_REQUIRED_PM_MODE CONFIG_ZTIMER_SEC_REQUIRED_PM_MODE
    #else
        #define CONFIG_ZTIMER_RTC_REQUIRED_PM_MODE ZTIMER_CLOCK_NO_REQUIRED_PM_MODE
    #endif
#endif
