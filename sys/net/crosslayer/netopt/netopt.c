...
static const char *_netopt_strmap[] = {
    ...
    [NETOPT_LORAWAN_APPEUI]        = "NETOPT_APPEUI",
    [NETOPT_LORAWAN_APPKEY]        = "NETOPT_APPKEY",
    [NETOPT_LORAWAN_APPSKEY]       = "NETOPT_APPSKEY",
    [NETOPT_LORAWAN_NWKSKEY]       = "NETOPT_NWKSKEY",
    [NETOPT_LORAWAN_DEVICE_CLASS]  = "NETOPT_DEVICE_CLASS",
    [NETOPT_LORAWAN_DR]            = "NETOPT_DR",
    [NETOPT_LORAWAN_ADR]           = "NETOPT_ADR",
    [NETOPT_LORAWAN_PUBLIC_NETWORK]= "NETOPT_PUBLIC_NETWORK",
    [NETOPT_LORAWAN_NETID]         = "NETOPT_NETID",
    [NETOPT_LORAWAN_TX_PORT]       = "NETOPT_TX_PORT",
    [NETOPT_LORAWAN_RX2_DR]        = "NETOPT_RX2_DR",
    [NETOPT_LORAWAN_RX2_FREQ]      = "NETOPT_RX2_FREQ",
    [NETOPT_LORAWAN_MAX_RX_ERROR]  = "NETOPT_MAX_RX_ERROR",
    [NETOPT_LORAWAN_MIN_RX_SYMBOL] = "NETOPT_MIN_RX_SYMBOL",
