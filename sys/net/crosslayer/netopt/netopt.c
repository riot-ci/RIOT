...
static const char *_netopt_strmap[] = {
    ...
    [NETOPT_DEVEUI]                = "NETOPT_DEVEUI",
    [NETOPT_DEVADDR]               = "NETOPT_DEVADDR",
    [NETOPT_APPEUI]                = "NETOPT_APPEUI",
    [NETOPT_APPKEY]                = "NETOPT_APPKEY",
    [NETOPT_APPSKEY]               = "NETOPT_APPSKEY",
    [NETOPT_NWKSKEY]               = "NETOPT_NWKSKEY",
    [NETOPT_DEVICE_CLASS]          = "NETOPT_DEVICE_CLASS",
    [NETOPT_DATARATE]              = "NETOPT_DATARATE",
    [NETOPT_ADAPTIVE_DATARATE]     = "NETOPT_ADAPTIVE_DATARATE",
    [NETOPT_PUBLIC_NETWORK]        = "NETOPT_PUBLIC_NETWORK",
    [NETOPT_NETID]                 = "NETOPT_NETID",
    [NETOPT_TX_PORT]               = "NETOPT_TX_PORT",
    [NETOPT_TX_CONFIRMABLE]        = "NETOPT_TX_CONFIRMABLE",
    [NETOPT_RX2_DATARATE]          = "NETOPT_RX2_DATARATE",
    [NETOPT_RX2_FREQ]              = "NETOPT_RX2_FREQ",
