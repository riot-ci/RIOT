...
static const char *_netopt_strmap[] = {
    ...
    [NETOPT_LORA_BANDWIDTH]        = "NETOPT_LORA_BANDWIDTH"
    [NETOPT_LORA_SPREADING_FACTOR] = "NETOPT_LORA_SPREADING_FACTOR",
    [NETOPT_LORA_CODING_RATE]      = "NETOPT_LORA_CODING_RATE",
    [NETOPT_LORA_SINGLE_RECEIVE]   = "NETOPT_LORA_SINGLE_RECEIVE",
    [NETOPT_LORA_RX_TIMEOUT]       = "NETOPT_LORA_RX_TIMEOUT",
    [NETOPT_LORA_TX_TIMEOUT]       = "NETOPT_LORA_TX_TIMEOUT",
    [NETOPT_LORA_SYMBOL_TIMEOUT]   = "NETOPT_LORA_SYMBOL_TIMEOUT",
    [NETOPT_LORA_SYNCWORD]         = "NETOPT_LORA_SYNCWORD",
    [NETOPT_LORA_HOP]              = "NETOPT_LORA_HOP",
    [NETOPT_LORA_HOP_PERIOD]       = "NETOPT_LORA_HOP_PERIOD",
    [NETOPT_CRC]                   = "NETOPT_CRC",
    [NETOPT_LORA_IMPLICIT]         = "NETOPT_LORA_IMPLICIT",
    [NETOPT_LORA_IQ_INVERT]        = "NETOPT_LORA_IQ_INVERT",
    [NETOPT_LORA_PAYLOAD_LENGTH]   = "NETOPT_LORA_PAYLOAD_LENGTH",
    [NETOPT_LORA_PREAMBLE_LENGTH]  = "NETOPT_LORA_PREAMBLE_LENGTH",
    [NETOPT_LORA_MODE]             = "NETOPT_LORA_MODE",
    [NETOPT_LORA_MAX_PAYLOAD]      = "NETOPT_LORA_MAX_PAYLOAD",
    [NETOPT_LORA_RANDOM]           = "NETOPT_LORA_RANDOM",
    [NETOPT_LORA_TIME_ON_AIR]      = "NETOPT_LORA_TIME_ON_AIR",
