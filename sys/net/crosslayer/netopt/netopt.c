...
static const char *_netopt_strmap[] = {
    ...
    [NETOPT_BATTERY_LEVEL]         = "NETOPT_BATTERY_LEVEL",
    [NETOPT_LINKCHECK_INTERVAL]    = "NETOPT_LINKCHECK_INTERVAL",
    [NETOPT_RX1_WINDOW_DELAY]      = "NETOPT_RX1_WINDOW_DELAY",
    [NETOPT_RX2_WINDOW_DELAY]      = "NETOPT_RX2_WINDOW_DELAY",
    [NETOPT_AUTO_REPLY]            = "NETOPT_AUTO_REPLY",
