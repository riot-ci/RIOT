 ...
 *
 * @file
 * @brief       Auto initialization for NRF24L01+ network interfaces
 *
...
static gnrc_netif_t _netif[NRF24L01P_NUM];
...
void auto_init_nrf24l01p(void)
{
    for (unsigned i = 0; i < NRF24L01P_NUM; i++) {
        ...
        gnrc_netif_nrf24l01p_create(&_netif[i], stacks[i],
                                    NRF24L01P_MAC_STACKSIZE,
                                    NRF24L01P_MAC_PRIO,
                                    "nrf24l01p",
