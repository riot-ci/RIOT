 ...
 *
 * Can be assigned to the variable the return value of @ref _handle_aro(), so
 * that the case that an NA does not contain an ARO (e.g. because upstream
 * router does not support it) can be dealt with.
 */
