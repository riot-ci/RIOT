...
#if (defined(MODULE_GNRC_NETIF_PHY_OFDM) && defined(MODULE_GNRC_NETIF_PHY_FSK))   ||	\
    (defined(MODULE_GNRC_NETIF_PHY_OFDM) && defined(MODULE_GNRC_NETIF_PHY_OQPSK)) ||	\
    (defined(MODULE_GNRC_NETIF_PHY_FSK)  && defined(MODULE_GNRC_NETIF_PHY_OQPSK))

/**
 * @brief   The netdev supports more then one PHY mode
 */
#define MODULE_GNRC_NETIF_PHY_MULTIMODE
#endif
...
#ifdef MODULE_GNRC_NETIF_PHY_MULTIMODE
         "       * \"phy_mode\" - select PHY mode\n"
#endif
#ifdef MODULE_GNRC_NETIF_PHY_OQPSK
         "       * \"chip_rate\" - BPSK/QPSK chip rate in kChip/s\n"
         "       * \"rate_mode\" - BPSK/QPSK rate mode\n"
#endif
#ifdef MODULE_GNRC_NETIF_PHY_OFDM
         "       * \"option\" - OFDM option\n"
         "       * \"scheme\" - OFDM modulation & coding scheme\n"
#endif
#ifdef MODULE_GNRC_NETIF_PHY_FSK
...
#endif /* MODULE_GNRC_NETIF_PHY_OQPSK */
#ifdef MODULE_GNRC_NETIF_PHY_OFDM
...
#endif /* MODULE_GNRC_NETIF_PHY_OFDM */
#ifdef MODULE_GNRC_NETIF_PHY_FSK
...
#endif /* MODULE_GNRC_NETIF_PHY_FSK */
...
#endif /* MODULE_GNRC_NETIF_PHY_MULTIMODE */
