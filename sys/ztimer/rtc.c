...
static uint32_t _ztimer_rtc_now(ztimer_dev_t *ztimer)
{
    (void)ztimer;
...
static void _ztimer_rtc_set(ztimer_dev_t *ztimer, uint32_t val)
{
...
static void _ztimer_rtc_cancel(ztimer_dev_t *ztimer)
{
    (void)ztimer;
    rtc_clear_alarm();
}
