...
void print_statistics(const matstat_state_t *state, const test_limits_t *limits)
{
    if (state->count == 0) {
...
void print_totals(const matstat_state_t *states, size_t nelem, const test_limits_t *limits)
{
...
void print_detailed(const matstat_state_t *states, size_t nelem)
{
    if (LOG2_STATS) {
