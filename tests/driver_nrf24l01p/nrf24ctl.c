...
int sc_nrf24ctl(int argc, char *argv[])
{
    ...
    switch (argc) {
        case 6: {
            ...
            if (pipe < 0 || pipe >= NRF24L01P_PX_NUM_OF) {
            ...
            if ((!strcmp(argv[2], "-s")) || (!strcmp(argv[2], "--set"))) {
                if (!(strcmp(argv[3], "address"))) {
                    ...
                    ret = nrf24l01p_set_rx_address(dev, address, pipe);
                    if (ret < 0) {
                    ...
                    ret = nrf24l01p_set_enable_pipe(dev, pipe, enable);
                    if (ret < 0) {
                        printf("[nrf24ctl] "
        ...
        case 5: {
            ...
            /* nrf24ctl <dev_index> --get <attribute> <pipe> */
                ...
                if (!(strcmp(argv[3], "address"))) {
                    ...
                    bool enable = false;
                    nrf24l01p_get_enable_pipe(dev, pipe, &enable);
