...
static void test_ipv6_ext_frag_reass_in_order(void)
{
    ...
    frag->nh = PROTNUM_UDP;
    frag->resv = 0U;
    ipv6_ext_frag_set_offset_more(frag, TEST_FRAG1_OFFSET, true);
    ...
    frag->nh = PROTNUM_UDP;
    frag->resv = 0U;
    ipv6_ext_frag_set_offset_more(frag, TEST_FRAG2_OFFSET, true);
    frag->id = byteorder_htonl(TEST_ID);
    ...
    frag->nh = PROTNUM_UDP;
    frag->resv = 0U;
    ipv6_ext_frag_set_offset_more(frag, TEST_FRAG3_OFFSET, false);
    frag->id = byteorder_htonl(TEST_ID);
...
static void test_ipv6_ext_frag_reass_one_frag(void)
{
    ...
    frag->nh = PROTNUM_UDP;
    frag->resv = 0U;
    ipv6_ext_frag_set_offset_more(frag, TEST_FRAG1_OFFSET, false);
    frag->id = byteorder_htonl(TEST_ID);
