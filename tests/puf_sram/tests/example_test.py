...
def main_func():
    ...
    p.add_argument("-n", "--number", type=int, default=DEFAULT_NUMBER,
                   help="Number of iterations, default: %s" % DEFAULT_NUMBER)
    p.add_argument("-t", "--off_time", type=int, default=DEFAULT_OFF_T,
                   help="Off time, default: %s [s]" % DEFAULT_OFF_T)
