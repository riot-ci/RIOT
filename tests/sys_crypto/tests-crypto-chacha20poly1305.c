...
static const uint8_t msg_1[] = {
    ...
    0x65, 0x6e, 0x74, 0x6c,
    0x65, 0x6d, 0x65, 0x6e, 0x20, 0x6f, 0x66, 0x20, 0x74, 0x68, 0x65, 0x20,
    0x63, 0x6c, 0x61, 0x73,
    0x73, 0x20, 0x6f, 0x66, 0x20, 0x27, 0x39, 0x39, 0x3a, 0x20, 0x49, 0x66,
    0x20, 0x49, 0x20, 0x63,
    0x6f, 0x75, 0x6c, 0x64, 0x20, 0x6f, 0x66, 0x66, 0x65, 0x72, 0x20, 0x79,
    0x6f, 0x75, 0x20, 0x6f,
    0x6e, 0x6c, 0x79, 0x20, 0x6f, 0x6e, 0x65, 0x20, 0x74, 0x69, 0x70, 0x20,
    0x66, 0x6f, 0x72, 0x20,
    0x74, 0x68, 0x65, 0x20, 0x66, 0x75, 0x74, 0x75, 0x72, 0x65, 0x2c, 0x20,
    0x73, 0x75, 0x6e, 0x73,
                                   ...
                                   const uint8_t *aad, size_t aadlen)
{
    ...
    TEST_ASSERT_EQUAL_INT(1,
                          chacha20poly1305_decrypt(ebuf, msglen + 16, pbuf,
                                                   &len, aad, aadlen, key,
                                                   nonce));
...
{
    _test_chacha20poly1305(key_1, nonce_1, msg_1, sizeof(msg_1), aad_1,
                           sizeof(aad_1));
}
