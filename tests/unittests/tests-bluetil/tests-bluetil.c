...
static void test_bluetil_addr(void)
{
    ...
    bluetil_addr_ipv6_iid_sprint(istr, addr[0]);
    ...
    bluetil_addr_ipv6_iid_sprint(istr, addr[1]);
    ...
    bluetil_addr_ipv6_iid_sprint(istr, addr[2]);
    ...
    bluetil_addr_ipv6_iid_sprint(istr, addr[3]);
