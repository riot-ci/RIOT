...
static void test_keccak800_run(bit_sequence* data, char* datastring, char* hashvalstring)
{
    /* Initialize */
...
static void test_keccak1600_run(bit_sequence* data, char* datastring, char* hashvalstring)
{
    /* Initialize */
